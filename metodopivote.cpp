...
/*Este programa recibe un vector de probabilidades de inclusión y retorna un vector de unos y ceros del tamaño del vector
 ...
 como el método del pivote y es un diseño de muestreo sin reemplazo. Consiste en partir el vector de probabilidades de
 inclusión en dos partes, y generando un nuevo vector de probabilidades de inclusión a partir de las 2 partes anteriores,
 y se vuelve a partir en 2 y con ello validando condiciones para llenar nuestro vector de unos y ceros resultante. 
 Debido a que el proceso solo depende del vector de probabilidades de inclusión inmediato anterior se le denota como un
 algoritmo martingala. En particular este método entre los que parten el vector de probabilidades de inclusión en cada paso
 solo modifica dos entradas del vector anterior de probabilidades de inclusión.
 */
